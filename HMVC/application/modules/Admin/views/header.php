                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li style="display:<?php echo (in_array("settings/access", $accesshead)) ? 'block' : 'none'; ?>">
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li style="display:<?php echo (in_array('admin/popup', $accesshead)) ? 'block' : 'none'; ?>"><a href="<?php echo base_url('admin/qrcode'); ?>">QR Code Change</a></li>
                                <li style="display:<?php echo (in_array('admin/popup', $accesshead)) ? 'block' : 'none'; ?>"><a href="<?php echo base_url('admin/Add-image'); ?>">Upload Achiever Image</a></li>
                                <li style="display:<?php echo (in_array('admin/popup', $accesshead)) ? 'block' : 'none'; ?>"><a href="<?php echo base_url('admin/Achiever-report'); ?>"> Achiever Report</a></li>
                                <li style="display:<?php echo (in_array('admin/popup', $accesshead)) ? 'block' : 'none'; ?>"><a href="<?php echo base_url('admin/set-withdraw-timing'); ?>">Set Withdraw Timing</a></li>
                            </ul>
                        </li>
                        <?php if (sub_admin == 0) { ?>
                        ...
                        <li style="display:<?php echo (in_array("kyc/access", $accesshead)) ? 'block' : 'none'; ?>">
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                ...
                                <li style="display:<?php echo (in_array('admin/kyc-history/rejected', $accesshead)) ? 'block' : 'none'; ?>"><a href="<?php echo base_url('admin/kycdetails'); ?>">KYC History</a></li>
                            </ul>
                        </li>
                        ...
                        <li style="display:<?php echo (in_array("mail/access", $accesshead)) ? 'block' : 'none'; ?>">
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li style="display:<?php echo (in_array('admin/inbox', $accesshead)) ? 'block' : 'none'; ?>"><a href="<?php echo base_url('admin/inbx'); ?>">Inbox</a></li>
                           <li style="display:<?php echo (in_array('admin/compose', $accesshead)) ? 'block' : 'none'; ?>"><a href="<?php echo base_url('admin/outbx'); ?>">Outbox</a></li>
                                <!-- <li style="display:<?php //echo (in_array('admin/outbox', $accesshead)) ? 'block' : 'none'; ?>"><a href="<?php //echo base_url('admin/outbox'); ?>">Outbox</a></li>  -->
                            </ul>
                        </li>
                        ...
                        <li style="display:<?php echo (in_array("mail/access", $accesshead)) ? 'block' : 'none'; ?>">
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li style="display:<?php echo (in_array('admin/inbox', $accesshead)) ? 'block' : 'none'; ?>"><a href="<?php echo base_url('admin/uploadimg'); ?>">Add image</a></li>
