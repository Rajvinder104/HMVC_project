        ...
        <div class="container-fluid">
            ...
            <div class="row card__row">
                ...
                foreach ($incomes as $incKey => $inc) :
                    ...
                    $getBalance2 = $this->Main_model->get_single_record($table, ['type' => $incKey, 'date(created_at)' => date('Y-m-d')], 'ifnull(sum(amount),0) as balance');
                ?>
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="font-weight-medium mb-0 mt-1">Today : <?php echo currency; ?> <?php echo number_format($getBalance2['balance'], 2); ?> </h5>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="small-box">
                                <div class="inner">
                                    <h3 class="font-size-16 text-uppercase mt-0 mt-2 primary-color">Total KYC </h3>
                                    <p class="mb-0">Total KYC : <?php echo $All_kyc; ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="small-box">
                                <div class="inner">
                                    <h3 class="font-size-16 text-uppercase mt-0 mt-2 primary-color">pending KYC</h3>
                                    <p class="mb-0">pending KYC : <?php echo $pending_kyc; ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="small-box">
                                <div class="inner">
                                    <h3 class="font-size-16 text-uppercase mt-0 mt-2 primary-color">Approved KYC</h3>
                                    <p class="mb-0">Approved KYC : <?php echo $approved_kyc; ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="small-box">
                                <div class="inner">
                                    <h3 class="font-size-16 text-uppercase mt-0 mt-2 primary-color">Rejected KYC</h3>
                                    <p class="mb-0">Rejected KYC : <?php echo $rejected_kyc; ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
