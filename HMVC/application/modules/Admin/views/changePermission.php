    ...
    <div class="container-fluid">
      ...
      <div>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
          <h5 class="border-bottom mt-3">logout</h5>
          <div class="form-check">
              <label> <input type="checkbox" name="admin/logout" value="admin/logout" <?php if (!empty($access['admin/logout'])) echo 'checked'; ?> class="form-check-input">logout</label>
            </div>
          </div>
        </div>
