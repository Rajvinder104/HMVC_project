...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('NewDashboard/'); ?>icard_style.css">
      ...
      <div class="hidden-print">
        <div style="cursor:hand;">
          <div class="container text-center" style="text-align:center">
            <input type="button" onClick="window.print()" value="Download" style="margin-top:20px" title="Take a print of icard">
