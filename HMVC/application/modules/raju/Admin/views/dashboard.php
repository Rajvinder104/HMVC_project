    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row card__row">
                ...
                <?php
                $access = $this->config->item('admin_access');
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="small-box">
                                    <div class="inner">
                                        <?php
                                        $setting = $this->Main_model->get_single_record('tbl_settings', array('id' => 1), '*'); ?>
                                        <label class="text-<?php echo ($setting[$key] == 0 ? 'success' : 'danger') ?>"><?php echo $acs; ?></label>
                                        <?php if ($setting[$key] == 0) { ?>
                                            <a class="btn btn-danger" href="<?php echo base_url('Admin/Settings/UpdateButton/' . $key . '/1') ?>"><?php echo 'OFF'; ?></a>
                                        <?php  } else { ?>
                                            <a class="btn btn-success" href="<?php echo base_url('Admin/Settings/UpdateButton/' . $key . '/0') ?>"><?php echo 'ON'; ?></a>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
