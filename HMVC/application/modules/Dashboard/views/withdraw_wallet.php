                                ...
                                <div class="wizard-content tab-content p-0">
                                    ...
                                    <div class="tab-pane active show" id="tabFundRequestForm">
                                        ...
                                        <div class="row">
                                            ...
                                            ?>
                                                <div class="col-md-12">
                                                    ...
                                                    <?php
                                                    $start_time = $withdrawtiming['start_withdraw_time'];
                                                    $end_time = $withdrawtiming['end_withdraw_time'];
                                        ...
                                        <?php
                                                        ...
                                                        echo '<span class="text-danger">Withdraw Only ' . $start_time_12h . ' To ' . $end_time_12h . ' !</span>';
                                                    }
                                                } else {
