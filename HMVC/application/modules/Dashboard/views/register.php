                                            ...
                                            <div class="card-body">
                                                <div class="">
                                                    <div class="form-element">
                                                        ...
                                                        <div class="form-wrap has-feedback text-danger mb-2">Do you have Sponsor ID
                                                        ...
                                                        <div class="form-wrap has-feedback" id="">
                                                            ...
                                                            <!-- onclick="submit_form(this,'registerForm')" -->
                                                        </div>
    ...
    <script>
        function docload(check) {
            if (check == 'yes') {
                ...
                radioButton.checked = false;
                document.getElementById("sponser_id").value = 'admin';
                check_sponser();
            }
        }
    </script>
