    ...
    <div class="container-fluid">
        <div class="">
            <div class="panel-heading">
                <h4 class="panel-title"><?php echo 'Reinvestment  '; ?></h4>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="card cstm-card">
                        <div class="card-body">
                            <p class="text-dark">Wallet balance: <span id=""><?php echo "$" . $wallet['wallet_balance']; ?></span></p>
                            <div class="wizard-content tab-content p-0">
                                <div class="tab-pane active show" id="tabFundRequestForm">
                                    <div>
                                        <div class="col-md-12 p-0">
                                            <?php echo form_open('dashboard/reinvest', array('id' => 'TopUpForm')); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="package_id">
                                                        ...
                                                        foreach ($packages as $key => $package) {
                                                            echo '<option value="' . $package['id'] . '">' . currency . ' ' . $package['price'] . ' </option>';
                                                        }
                                                        ?>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group" id="SaveBtn">
                                                <button type="button" id="stake" name="save" class="btn btn-info" onclick="activateNow(this,'TopUpForm')"><?php echo 'Reinvest'; ?></button>
                                            </div>
                                            <?php echo form_close(); ?>
                                        </div>
                                    </div>
