                                ...
                                <div class="wizard-content tab-content p-0">
                                    ...
                                    <div class="tab-pane active show" id="tabFundRequestForm">
                                        ...
                                        <div class="row">
                                            ...
                                            if ($withdrawopen == true || empty($dateWithdraw)) { ?>
                                                <!-- BEGIN col-6 -->
                                                <?php if (withdraw_status == 0) { ?>
                                                    <div class="col-md-12">
                                                        ...
                                                        // if (date('D') == 'Wed') {
                                                            if ($currenttime >= $withdrawtiming['start_withdraw_time'] && $currenttime <=  $withdrawtiming['end_withdraw_time']) {
                                            ...
                                            <?php
                                                            ...
                                                            echo '<span class="text-danger">Withdraw Only ' . $withdrawtiming['start_withdraw_time'] . $pm . ' To ' . $withdrawtiming['end_withdraw_time'] . $pm . ' !</span>';
                                                        }
                                                    } else {
