...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>/MainAssets/UserAssets/css/style.css">
        ...
        <div class="container">
            <div class="reg-form">
                ...
                <div class="main-form" id="main_hide">
                    ...
                    <?php echo form_open('activate', array('id' => 'registerForm')); ?>
                    ...
                    <div class="form-group mt-5 text-center">
                        <button id="btn" type="submit" class="btn form-btn w-50">Activate</button>
                    </div>
                    <?php echo form_close(); ?>
                </div>
            </div>
